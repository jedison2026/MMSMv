...
def fn(space):     #fn目标函数，space超参数搜索空间
...
def hyper_searching(args):
    ...
    #for trial in trials.trials[:2]:    前两个试验 trials.trials[:2] 的详细信息
        #print(trial)
...
if __name__ == '__main__':
    ...
    result, trials=hyper_searching(args)     #能包含最佳参数集的相关信息或最佳模型的性能结果
                                             # trials可能是记录了搜索过程中所有试验的详细信息，包括每组参数的性能等
