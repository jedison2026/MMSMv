...
def add_train_argument(p):
    p.add_argument('--data_path',type=str,default='data/bbbp.csv',
                   help='The path of input CSV file.Provide any CSV file path you want to use.')
    ...
    p.add_argument('--dataset_type',type=str,default='classification',choices=['classification', 'regression'],
                   help='The type of dataset.')
    p.add_argument('--is_multitask',type=int,default=0,#0
    ...
    p.add_argument('--num_folds',type=int,default=1,#1      #交叉验证折数
    ...
    p.add_argument('--epochs',type=int,default=3,#50
                   help='The number of epochs.')
    p.add_argument('--batch_size',type=int,default=30,#30改为16、8、2、1
    ...
    p.add_argument('--num_attention_heads', type=int, default=2,
                   help='Number of attention heads for multi-head attention.')#增加
    p.add_argument('--num_gru_layers', type=int, default=2,
                   help='Number of GRU layers in the model.')#增加
    p.add_argument('--num_lstm_layers', type=int, default=2,
                   help='Number of LSTM layers in the model.')  # 增加
    p.add_argument('--dropout_gnn',type=float,default=0.05,#0.05
    ...
    p.add_argument('--dataset', type=str, default='bbbp1', help='root directory of dataset.')
    p.add_argument('--weight_decay', type=float, default=0.01, help='ablation_weight decay .')
    p.add_argument('--input_dim', type=int, default=64, help='Input dimension for the model')
    p.add_argument('--num_heads', type=int, default=8, help='Number of attention heads.')#多头注意力新增
    p.add_argument('--d_model', type=int, default=512, help='Dimension of the model.')
    p.add_argument('--d_v', type=int, default=64, help='Dimension of each attention head.')
